...
if(! isset($_SESSION['team_original_members'])) {
    $_SESSION['team_original_members'] = array();
}
...
//    echo $name;
    if(empty($name)){
        $_SESSION['team_original_members'][$sid] = $name;
//        unset($_SESSION['team_original_members'][$sid]); // 刪除項目
    } else {
        unset($_SESSION['team_original_members'][$sid]);
//        $_SESSION['team_original_members'][$sid] = $name; // 設定
    }



echo json_encode($_SESSION['team_original_members']); // 查詢
