...
echo json_encode($_SESSION['sel_members']); // 查詢
...
?>
    ...
    <?php foreach ($sids as $sid):
        ...
        ?>
        <tr class="find">
            <td class="member_name memberlist_username_id_add"><?= $row['name'] ?></td>
            <td class="add_btn memberlist_add" data-sid="<?= $row['sid'] ?>">新增</td>
        </tr>
    <?php endforeach; ?>
